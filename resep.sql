...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2021 at 05:09 PM
...
(1, 'rica-rica', 'Ayam Rica-Rica', 'Rica-rica merupakan salah satu bumbu bercita rasa pedas yang berasal dari Manado, Sulawesi Utara. Bumbu rica-rica cocok dimasak dengan ikan, daging sapi, atau ayam. Kali ini, kamu bisa mencoba olahan ayam dengan bumbu rica-rica yang pedas manis', 'Pedas', 'Lauk', '', ''),
...
(13, 'ayam-krispy-bumbu-cabai', 'Ayam krispy bumbu cabai', 'Ayam bisa diolah menjadi berbagai macam menu makanan. Bahkan saat ini, ayam yang sudah digoreng dengan tepung diberi sedikit sensasi hancur dengan cara digeprek.\r\n\r\nMemangnya, apa saja kandungan gizi di dalam daging ayam segar? Berdasarkan Data Komposisi Pangan Indonesia, 100 gram daging ayam memiliki kandungan gizi', 'Lauk', 'Pedas', '', ''),
(14, 'bubur-edamame-telur-puyuh', 'Bubur edamame telur puyuh', 'Edamame merupakan sumber protein nabati untuk membangun otot dan sel-sel tubuh. Edamame juga mengandung serat yang baik untuk pencernaan anak.', 'Vegetarian', 'Bubur', '', ''),
(15, 'kangkung-bumbu-kemiri-pedas', 'Kangkung bumbu kemiri pedas', 'Kangkung bumbu kemiri pedas. Kangkung merupakan salah satu tanaman yang banyak ditemui di negara-negara Asia, khususnya di Indonesia.', 'Sayur', 'Pedas', 'Vegetarian', ''),
(16, 'kangkung-bumbu-tauco', 'Kangkung bumbu tauco', 'Kangkung bumbu tauco. kangkung Tak jauh berbeda dengan jenis sayuran lainnya, sayuran yang punya nama latin Ipomoea aquatica ini mengandung sejumlah nutrisi yang baik bagi tubuh.', 'Vegetarian', 'Satuy', '', ''),
(17, 'resep-kangkung-krispy', 'Resep Kangkung Krispy', 'Kangkung merupakan salah satu tanaman yang banyak ditemui di negara-negara Asia, khususnya di Indonesia. Dikutip dari situs Data Komposisi Pangan Indonesia, berikut ini adalah kandungan gizi yang terdapat pada 100 gram (g) kangkung segar', 'Sayur', '', '', ''),
(18, 'sambal-goreng-tempe', 'Sambal Goreng Tempe', 'Tempe adalah makanan yang pasti tidak asing bagi Anda. Makanan fermentasi dari kacang kedelai ini telah menemani hidup sebagai orang Indonesia. Rasa khas tempe dan struktur yang sangat berbeda dari tahu ini selain murah juga bisa bikin ketagihan. Beragam kandungan pada tempe menyimpan banyak manfaat bagi kesehatan tubuh.', 'Sambal', 'Pedas', '', ''),
...
(20, 'sayur-asem', 'Sayur asem', 'Sayur asem adalah satu di antara menu masakan yang memiliki rasa asam, tetapi ada pula yang membuatnya menjadi pedas. Masakan ini terdiri dari berbagai campuran sayur-sayuran dan kacang-kacangan.', 'Sayur', 'Kuah', '', ''),
(21, 'tumis-kacang-panjang-dan-tempe', 'Tumis kacang panjang dan tempe', 'Kacang panjang tentu buka nama sayuran yang terdengar asing di telinga masyarakat Indonesia. Meski umum dimakan, mungkin tak banyak yang mengetahui kandungan gizi dan manfaat kesehatan dari kacang panjang.', 'Sayur', 'Vegetarian', '', ''),
(22, 'tumis-udang-buncis', 'Tumis udang buncis', 'Udang merupakan salah satu boga bahari yang banyak dikonsumsi di seluruh dunia. Dalam dunia hewan, udang masuk ke dalam ordo decapoda dan banyak dibudidayakan secara komersial dalam budi daya perairan.', 'Sayur', 'Vegetarian', '', '');
